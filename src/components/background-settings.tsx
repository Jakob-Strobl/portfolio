...
export function BackgroundSettingsTrigger(props: BackgroundSettingsTriggerProps) {
  ...
  return (
    <button
      ...
      type="button"
      class="flex h-8 w-8 items-center justify-center rounded-md p-1 transition-all duration-200 hover:bg-white/10 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-night-300"
      classList={{
