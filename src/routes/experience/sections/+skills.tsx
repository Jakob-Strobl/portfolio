    ...
    <dl class="grid gap-4 sm:grid-cols-2">
      <div>
        ...
        <dd class="experience-card-meta mt-1">
          TypeScript, JavaScript, Rust, C#/.NET, GDScript, Python, C/C++, Bun, Node.js, Deno
        </dd>
      </div>
      ...
      <div>
        ...
        <dd class="experience-card-meta mt-1">AI product integration, computer vision, New Relic, PostHog</dd>
      </div>

      <div>
        <dt class="experience-card-subtitle">Engineering practice</dt>
        <dd class="experience-card-meta mt-1">Product design, system architecture, CI/CD, testing, observability</dd>
      </div>
    </dl>
