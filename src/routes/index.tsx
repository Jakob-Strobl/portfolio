    ...
    <>
      ...
      <div class="xs:w-4/5">
        ...
        >
          ...
          <p class="text-center text-base font-light text-gray-300">Full-stack developer &amp; indie builder</p>
          <div class="w-full">
          ...
          <div class="flex items-center gap-2 text-gray-300">
            <p class="group flex h-8 translate-y-px items-center rounded-md py-1 pr-1 pl-1.5 text-sm transition-colors duration-200 hover:bg-white/10 focus-within:bg-white/10">
