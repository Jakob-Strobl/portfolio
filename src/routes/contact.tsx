      ...
      >
        <Shadow warmupDelayMs={0} contentFadeInDelayMs={400}>
          <div class="flex w-full flex-col text-base md:text-lg">
            ...
            <p class="mt-4 w-full max-w-[calc(116px_+_153.17px_+_2rem)] text-base text-white/80 sm:max-w-[calc(171.5px_+_226.45px_+_3rem)] md:text-lg xl:max-w-[calc(257px_+_339.35px_+_4rem)]">
              <span class="block">
            ...
            <div class="mx-4 mt-6 flex justify-center gap-6 sm:mx-8 sm:gap-8 xl:mx-12 xl:gap-10">
              <div id="github">
                <a
            ...
            <p class="mt-6 w-full max-w-[calc(116px_+_153.17px_+_2rem)] text-base text-white/80 sm:max-w-[calc(171.5px_+_226.45px_+_3rem)] md:text-lg xl:max-w-[calc(257px_+_339.35px_+_4rem)]">
